...
export const ui = {
    zh: {
        ...
        "hero.title.b": "智能体专用",
        "hero.sub":
            "将文档、表格和网页转换为大模型可直接消费的文本，并为图片、图表等视觉内容保留可追踪链接，方便智能体与视觉模型协同处理。",
        ...
        "cli.title.b": "",
        "cli.sub":
            "一条命令接收文档，标准输出交给大模型。无法解析的内容，会标注链接与原因，交给智能体决策处理。",
        "cli.f1": "分页提取",
        "cli.f2": "表格裁剪",
        "cli.f3": "图片定位",
        ...
        "runtime.c3.body": "Worker、Lambda、FaaS 可运行，冷启动友好",
        "runtime.note":
            "配合浏览器内或本地模型，文档从解析到推理整条链路都不出端 —— 合同、报表、隐私数据留在原地。",

        "quickStart.eyebrow": "快速开始",
        "quickStart.title": "3 步把文档转成模型能直接读的文本",
        "quickStart.sub": "安装、解析、缺失内容链接标记和提示，一次完成。",
        ...
        "footer.tagline": "把文档变成大模型能直接读的文本",
    ...
    en: {
        ...
        "hero.badge": "BUILT FOR AGENTS",
        "hero.title.a": "document parsing",
        "hero.title.b": "Agent-first",
        "hero.sub":
            "Turn documents, tables and web pages into text your LLM can consume directly, while preserving traceable links for images, charts and other visual content so agents and vision models can work together.",
        "hero.github": "View on GitHub",
        "term.tools": "TOOLS",
        "term.toolsHint": "agent picks autonomously",

        "cli.eyebrow": "CLI AS THE INTERFACE",
        "cli.title.a": "Unix philosophy: pipes are the interface.",
        "cli.title.b": "",
        "cli.sub":
            "One command takes the document; stdout feeds the LLM. Content that cannot be parsed reliably is marked with a link and a reason, so the agent can decide what to do next.",
        ...
        "quickStart.title": "Turn documents into model-ready text in 3 steps.",
        "quickStart.sub":
            "Install, parse, and mark missing content with links and warnings — all in one flow.",
        "quickStart.s1": "Install Spoor",
        "quickStart.s2": "Parse PDF",
        "quickStart.s3": "Get text your model can use directly",
        ...
        "footer.legal":
            "Offline, single binary — files never leave your runtime",
    },
} as const;
